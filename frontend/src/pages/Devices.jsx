...
const Devices = () => {
    ...
    const fetchBabies = async () => {
        try {
            const res = await axios.get('http://localhost:5000/api/babies');
            setBabies(res.data);
    ...
    const handleAddBaby = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://localhost:5000/api/babies', {
                name: babyName,
                ageMonths: babyAge
            });
    ...
    const handlePair = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://localhost:5000/api/devices/pair', {
